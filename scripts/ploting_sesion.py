...
c_ratio_log = np.loadtxt('../plots/mlp/composite_trained_mlp_ratio.txt')
...
c_ratio = np.loadtxt('../plots/mlp/full_truth_mlp_ratio.txt')
...
c_diff_log = np.loadtxt('../plots/mlp/composite_trained_mlp_diff.txt')
...
c_full_log = np.loadtxt('../plots/mlp/full_trained_mlp_ratio.txt')
...
plt.clf()
c_full_diff = np.loadtxt('../plots/mlp/full_trained_mlp_diff.txt')
...
roc_composite = np.loadtxt('../plots/mlp/composite_trained_mlp_sigbkg.txt')
roc_full = np.loadtxt('../plots/mlp/full_trained_mlp_sigbkg.txt')
roc_truth = np.loadtxt('../plots/mlp/full_truth_mlp_sigbkg.txt')
from sklearn.metrics import roc_curve, auc
roc_composite_auc = auc(roc_composite[:,1],1.-roc_composite[:,0])
roc_full_auc = auc(roc_full[:,1],1.-roc_full[:,0])
roc_truth_auc = auc(roc_truth[:,1],1.-roc_truth[:,0])
plt.figure()
plt.plot(roc_composite[:,1], 1.-roc_composite[:,0], label='Sig eff Bkg rej composite (area = %0.2f)' % roc_composite_auc)
plt.plot(roc_full[:,1], 1.-roc_full[:,0], label='Sig eff Bkg rej full trained (area = %0.2f)' % roc_full_auc)
...
c_f1_f0_train = np.loadtxt('../plots/mlp/decomposed_trained_f1_f0_mlp_ratio_trained.txt')
c_f1_f0_truth = np.loadtxt('../plots/mlp/decomposed_trained_f1_f0_mlp_ratio_truth.txt')
c_f2_f0_train = np.loadtxt('../plots/mlp/decomposed_trained_f2_f0_mlp_ratio_trained.txt')
c_f2_f0_truth = np.loadtxt('../plots/mlp/decomposed_trained_f2_f0_mlp_ratio_truth.txt')
c_f2_f1_train = np.loadtxt('../plots/mlp/decomposed_trained_f2_f1_mlp_ratio_trained.txt')
c_f2_f1_truth = np.loadtxt('../plots/mlp/decomposed_trained_f2_f1_mlp_ratio_truth.txt')
plt.subplot(311)
...
plt.legend()
plt.savefig('../plots/decomposed_comparison_mlp_ratio.png')
plt.clf()
# Multiple plot for all pair-wise ROC
c_f1_f0_train_roc = np.loadtxt('../plots/mlp/decomposed_trained_f1_f0_mlp_roc.txt')
c_f1_f0_truth_roc = np.loadtxt('../plots/mlp/decomposed_truth_f1_f0_mlp_roc.txt')
c_f2_f0_train_roc = np.loadtxt('../plots/mlp/decomposed_trained_f2_f0_mlp_roc.txt')
c_f2_f0_truth_roc = np.loadtxt('../plots/mlp/decomposed_truth_f2_f0_mlp_roc.txt')
c_f2_f1_train_roc = np.loadtxt('../plots/mlp/decomposed_trained_f2_f1_mlp_roc.txt')
c_f2_f1_truth_roc = np.loadtxt('../plots/mlp/decomposed_truth_f2_f1_mlp_roc.txt')
...
plt.legend(loc="lower right")
plt.savefig('../plots/decomposed_comparison_mlp_roc.png')
