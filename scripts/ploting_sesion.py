...
c_f1_f0_train_roc = np.loadtxt('../plots/logistic/decomposed_trained_f1_f0_logistic_roc.txt')
c_f1_f0_truth_roc = np.loadtxt('../plots/logistic/decomposed_truth_f1_f0_logistic_roc.txt')
c_f2_f0_train_roc = np.loadtxt('../plots/logistic/decomposed_trained_f2_f0_logistic_roc.txt')
c_f2_f0_truth_roc = np.loadtxt('../plots/logistic/decomposed_truth_f2_f0_logistic_roc.txt')
c_f2_f1_train_roc = np.loadtxt('../plots/logistic/decomposed_trained_f2_f1_logistic_roc.txt')
c_f2_f1_truth_roc = np.loadtxt('../plots/logistic/decomposed_truth_f2_f1_logistic_roc.txt')
...
plt.legend(loc="lower right")
plt.savefig('../plots/decomposed_comparison_logistic_roc.png')
