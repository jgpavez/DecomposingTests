...
![decomposed model](https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.10/10dim/decomposed_model.png)
...
![decomposed model](https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.10/10dim/full_model.png)
...
![All ROC](https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.10/10dim/full_comparison_mlp_sigbkg.png)
...
shown
 ...
 0.10                   | 0.05
:-------------------------:|:-------------------------:
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.10/10dim/full_model.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.05/10dim/full_model.png" width="350" >
 0.01                   | 0.005
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.01/10dim/full_model.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.005/10dim/full_model.png" width="350" >
...
and background is shown, notice that only histograms for k < j is shown
 ...
 0.10                   | 0.05
:-------------------------:|:-------------------------:
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.10/10dim/decomp_all_mlp_hist.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.05/10dim/decomp_all_mlp_hist.png" width="350" >
 0.01                   | 0.005
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.01/10dim/decomp_all_mlp_hist.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.005/10dim/decomp_all_mlp_hist.png" width="350" >

The ratio histograms for the composite, full trained and true cases is shown in the next image, those histograms are constructed over data sampled from the distribution of F0 background and f0 signal.

 0.10                   | 0.05
:-------------------------:|:-------------------------:
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.10/10dim/ratio_comparison_mlp_hist.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.05/10dim/ratio_comparison_mlp_hist.png" width="350" >
 0.01                   | 0.005
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.01/10dim/ratio_comparison_mlp_hist.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.005/10dim/ratio_comparison_mlp_hist.png" width="350" >
...
Finally, in the next image the Signal Efficiency - Background Rejection curves for the composed, full trained and true ratio are shown for each one of the cases
 ...
 0.10                   | 0.05
:-------------------------:|:-------------------------:
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.10/10dim/full_comparison_mlp_sigbkg.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.05/10dim/full_comparison_mlp_sigbkg.png" width="350" >
 0.01                   | 0.005
<img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.01/10dim/full_comparison_mlp_sigbkg.png" width="350">  | <img src="https://github.com/jgpavez/systematics/blob/multidim/plots/mlp/0.005/10dim/full_comparison_mlp_sigbkg.png" width="350" >
